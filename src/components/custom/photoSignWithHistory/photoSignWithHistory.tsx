          ...
          getPhotoSignHistory?.isError && (
            <AppBar position="relative" color="primary">
              <Alert
                ...
                errorDetail={getPhotoSignHistory?.error_detail ?? ""}
                color="error"
              />
            </AppBar>
          )
          ...
          >
            <AppBar position="relative" color="secondary">
              ...
              >
                ...
                >
                  {
                    t("ACNo") + ".:".concat(data?.COMP_CD, "-", data?.BRANCH_CD, "-", data?.ACCT_TYPE, "-", data?.ACCT_CD, t("Account_Name") + ":", LatestPhotoSignData?.[0]?.ACCT_NM)
