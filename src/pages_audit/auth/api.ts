  ...
  return [
    {
      ...
      NOTE: "It is an enterprise browser-based multi-channel banking solution that enables full range of banking services and content to customers with different user profiles, efficiently and reliably.",
      DASHBOARD_APP_LOGO:
