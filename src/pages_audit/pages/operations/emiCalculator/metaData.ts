    ...
    fields: [
      {
        ...
        options: (authState) => API.getEMIInstType({COMP_CD: authState?.companyID, BRANCH_CD: authState?.user?.branchCode}),
      ...
      },
      {
        ...
        schemaValidation: {
          type: "string",
          rules: [
            { name: "required", params: [t("LoanAmountisrequired")] },
          ],
        },
        GridProps: { xs: 6, sm: 3, md: 3, lg: 3, xl: 3} 
      },
      {
        ...
        schemaValidation: {
          type: "string",
          rules: [
            { name: "required", params: [t("InterestRateisrequired")] },
          ],
        },
        GridProps: { xs: 6, sm: 3, md: 3, lg: 3, xl: 3},
      },
      {
        ...
        options: ( authState) => API.getEMICalcIntFund({COMP_CD: authState?.companyID, BRANCH_CD: authState?.user?.branchCode}),
      ...
      },
      {
        ...
        label: "Period",
        placeholder:"Period",
        options: (authState) => API.getEMICalcPeriod({COMP_CD: authState?.companyID, BRANCH_CD: authState?.user?.branchCode}),
      ...
      },
      {
        ...
        schemaValidation: {
          type: "string",
          rules: [
            { name: "required", params: [t("NoofInstallmentisrequired")]}
          ],
        },
