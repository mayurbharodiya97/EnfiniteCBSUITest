              ...
              <CardContent ref={printRef}>
                <Grid item xs={12} spacing={1}>
                  <Typography
                    ...
                    variant="h6"
                  >
                    {"ACUTE MERCANTILE CO.-OP.BANK LTD"}
                  </Typography>
                </Grid>
                <Grid item xs={12} spacing={1}>
                  <Typography
                ...
                <Grid item xs={12} className={classes.box}>
                  ...
                  <Paper className={classes.textField}>{"1"}</Paper>
                </Grid>
                <Grid item xs={12} className={classes.box}>
                  <Paper className={classes.label}> {t("keyNumber")} : </Paper>
                  <Paper className={classes.textField}>{""}</Paper>
                </Grid>
                <Grid item xs={12} className={classes.box}>
                  <Paper className={classes.label}> {t("lockerSize")} : </Paper>
                  <Paper className={classes.textField}>{"A [LARGE]"}</Paper>
                </Grid>
                <Grid item xs={12} className={classes.box}>
                ...
                <Grid item xs={12} className={classes.box}>
                  ...
                  <Paper className={classes.textField}>{"RSS"}</Paper>
                </Grid>
                <Grid item xs={12} className={classes.box}>
                  <Paper className={classes.label}>
                    {" "}
                ...
                <Grid item xs={12} className={classes.box}>
                  ...
                  <Paper className={classes.textField}>{"adi"} </Paper>
                </Grid>
              </CardContent>
            </Card>
          </div>
