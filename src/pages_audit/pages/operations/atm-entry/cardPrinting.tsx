          ...
          <div id="draggable-modal-title">
            <Card>
              <CardContent>
                ...
                <Grid item xs={12} className={classes.box}>
                  <FormLabel className={classes.label}>{t("Add1")}: </FormLabel>
                  <TextField
                    disabled
                    className={classes.textField}
                ...
                <Grid item xs={12} className={classes.box}>
                  <FormLabel className={classes.label}>{t("Add3")}: </FormLabel>
                  <TextField
                    disabled
                    className={classes.textField}
                    value={cardData?.ADDRESS3 ?? ""}
                    style={{ width: "calc(100% - 303px)" }}
                    InputProps={{
                      classes: { input: classes.input },
                    }}
                    variant="outlined"
