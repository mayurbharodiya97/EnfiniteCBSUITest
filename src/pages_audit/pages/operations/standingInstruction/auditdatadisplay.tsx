...
import { AuditgridMetaData } from "./gridMetaData";
...
const AuditData = ({ griddata, open, onClose }) => {
    ...
    const setCurrentAction = useCallback(async (actionData) => {
    ...
    AuditgridMetaData.gridConfig.gridLabel = `Execute Date : ${formatDate(griddata.EXECUTE_DT)} SI Audit Trail`;
    return (
        <Fragment>
