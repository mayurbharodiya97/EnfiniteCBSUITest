...
export const standingInsructionGridMetaData: GridMetaDataType = {
  gridConfig: {
    dense: true,
    gridLabel: "Standing Instruction Entry (TRN/394)",
    rowIdColumn: "TRAN_CD",
    defaultColumnConfig: {
      width: 200,
      maxWidth: 450,
...
export const standingInsructionViewGridMetaData: GridMetaDataType = {
  gridConfig: {
    dense: true,
    gridLabel: "Standing Instruction Entry (ETRN/394)",
    rowIdColumn: "LINE_ID",
    defaultColumnConfig: {
      width: 200,
      maxWidth: 450,
...
export const siasExecutedGridMetadata: GridMetaDataType = {
  ...
  columns: [
    ...
    {
      accessor: "CR_BRANCH_CD",
      columnName: "Credit A/C Branch Code",
      sequence: 2,
      alignment: "left",
      componentType: "default",
      width: 100,
...
export const siExecuteDetailViewGridMetaData: GridMetaDataType = {
  gridConfig: {
    ...
    disableSorting: false,
    hideHeader: false,
    footerNote:"Double Click on Records to Delete the Transaction",
    disableGroupBy: true,
    enablePagination: true,
    pageSizes: [20, 30, 50],
    defaultPageSize: 20,
  ...
  columns: [
    ...
    },
    {
      ...
      sequence: 14,
      alignment: "center",
      shouldExclude: (initialValue, original, prevRows, nextRows, rowClicked, data) => {
        // Exclude if rowClicked is false or SI_EXECUTE_FLG is not 'N'
        return !rowClicked || (data?.SI_EXECUTE_FLG !== 'N');
      },
    },
  ],
}
