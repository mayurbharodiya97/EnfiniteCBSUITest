...
export const guardianjoint_tab_metadata = {
    form: {
        name: "guardianjoint_tab_form",
        label: "", 
    ...
    fields: [
        {
            ...
            _fields: [
                ...
                },
                {
                    ...
                    disableCaching: true,
                    options: (dependentValue, formState, _, authState) => getOptionsOnPinParentArea(_?.["JOINT_GUARDIAN_DTL.PIN_CODE"]?.value, formState, _, authState),
                    _optionsKey: "indSubareaMaiwejfjwefnOpjoint",
                    setValueOnDependentFieldsChange: (dependentFields) => {
                        const pincode = dependentFields["JOINT_GUARDIAN_DTL.PIN_CODE"]
                        if(Boolean(pincode)) {
                            if(pincode.length<6) {
                                return "";
                            }
                ...
                },
                {
                    ...
                    setValueOnDependentFieldsChange: (dependentFields) => {
                      const optionData = dependentFields?.["JOINT_GUARDIAN_DTL.AREA_CD"].optionData;
