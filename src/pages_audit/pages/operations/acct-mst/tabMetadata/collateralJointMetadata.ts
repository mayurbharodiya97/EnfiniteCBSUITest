...
import { AlphaNumericValidate, getOptionsOnPinParentArea } from "../../c-kyc/api";
    ...
    fields: [
        {
            ...
            _fields: [
                ...
                },
                {
                    ...
                    options: (dependentValue, formState, _, authState) => API.getGuardianorRelationTypeOp({COMP_CD: authState?.companyID, BRANCH_CD: authState?.user?.branchCode}),
                ...
                },
                {
                    ...
                    disableCaching: true,
                    options: (dependentValue, formState, _, authState) => getOptionsOnPinParentArea(_?.["JOINT_HYPOTHICATION_DTL.PIN_CODE"]?.value, formState, _, authState),
                    _optionsKey: "indSubareaMaiwejfjwefnOpjoint",
                    setValueOnDependentFieldsChange: (dependentFields) => {
                        const pincode = dependentFields["JOINT_HYPOTHICATION_DTL.PIN_CODE"]
                        if(Boolean(pincode)) {
                            if(pincode.length<6) {
                                return "";
                            }
                ...
                },
                {
                    ...
                    setValueOnDependentFieldsChange: (dependentFields) => {
                      const optionData = dependentFields?.["JOINT_HYPOTHICATION_DTL.AREA_CD"].optionData;
                ...
                },
                {
                    ...
                    name: "MORT_TYPE",
                    label: "Mort. Type",
                    options: (dependentValue, formState, _, authState) => API.getMortgageTypeOp({COMP_CD: authState?.companyID, BRANCH_CD: authState?.user?.branchCode}),
                ...
                },
                {
                    ...
                    name: "VALUER_CODE",
                    label: "Name",
                    options: (dependentValue, formState, _, authState) => API.getValuerTypeOp({COMP_CD: authState?.companyID, BRANCH_CD: authState?.user?.branchCode}),
                ...
                },
                {
                    ...
                    name: "ADVOCATE_CODE",
                    label: "Advocate",
                    options: (dependentValue, formState, _, authState) => API.getAdvocateTypeOp({COMP_CD: authState?.companyID, BRANCH_CD: authState?.user?.branchCode}),
