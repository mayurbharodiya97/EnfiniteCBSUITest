...
import {
  strLevelBranchEditFormMetaData,
  suspiciousTransactionGridMetaData,
} from "./metadata";
    ...
    <>
      <>
        <FormWrapper
          ...
          metaData={strLevelBranchEditFormMetaData as MetaDataType}
          initialValues={data ?? {}}
          ...
          >
            <>
              ...
              <GridWrapper
                ...
                finalMetaData={
                  suspiciousTransactionGridMetaData as GridMetaDataType
                }
                data={[]}
                setData={() => null}
...
export const StrBranchLevelFormWrapper = ({ onClose }) => {
