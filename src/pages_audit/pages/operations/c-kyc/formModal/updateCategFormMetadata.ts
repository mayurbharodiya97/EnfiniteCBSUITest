        ...
        },
        {
          ...
          postValidationSetCrossFieldValues: (
            ...
            let reqObj = {
              ...
              DUE_AMT: DUE_AMT,
              INT_RATE:
                dependentFieldsValues?.["MAPPED_ACCOUNTS.NEW_INT_RATE"]?.value ?? "",
              PENAL_RATE:
                dependentFieldsValues?.["MAPPED_ACCOUNTS.NEW_PENAL_RATE"]?.value ?? "",
              AG_CLR_RATE:
                dependentFieldsValues?.["MAPPED_ACCOUNTS.NEW_AG_CL_RATE"]?.value ?? "",
