...
import { Grid, Typography, Divider, Skeleton, Collapse, IconButton, Button, Tooltip } from '@mui/material';
          ...
          >
            ...
            <Grid item xs={12} sm={6} md={6} style={{ paddingBottom: "10px" }}>
                ...
                >
                    ...
                    <Button variant="contained" color="secondary" onClick={() =>fileUploadControl?.current?.click()}>Upload Photo</Button>
                        <input
                        name="fileselect"
                        type="file"
                        style={{ display: "none" }}
            ...
            <Grid item xs={12} sm={6} md={6} style={{ paddingBottom: "10px" }}>
                ...
                >
                    ...
                    <Button variant="contained" color="secondary" onClick={() =>fileSignUploadControl?.current?.click()}>Upload Signature</Button>
                        <input
                        name="fileselect"
                        type="file"
                        style={{ display: "none" }}
