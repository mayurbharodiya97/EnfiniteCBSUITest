...
import { declaration_legal_meta_data } from '../../metadata/legal/legaldeclarationdetails';
// import { format } from 'date-fns';

const DeclarationDetailsLegal = ({isCustomerData, setIsCustomerData, isLoading, setIsLoading}) => {
            ...
            {isCustomerData ? <Grid 
                ...
                <Grid item>
                    <FormWrapper 
                        ...
                        metaData={declaration_legal_meta_data as MetaDataType}
                        formStyle={{}}
                        hideHeader={true}
                    />
                </Grid>
...
export default DeclarationDetailsLegal