...
import {
  bank_dtl_grid_meta_data,
  financial_dtl_grid_meta_data,
} from "./metadata";
...
const FinancialDTLComp = ({ open, onClose }) => {
  ...
  const {
    ...
    isError: isFinancialDTLError,
    isFetching: isFinancialDTLFetching,
    isLoading: isFinancialDTLLoading,
    refetch: financialDTLRefetch,
  } = useQuery<any, any>(["getFinancialDTLGridData", { data }], () =>
