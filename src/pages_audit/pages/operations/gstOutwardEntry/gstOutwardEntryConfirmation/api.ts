...
export const getGstOutwardConfirmationRetrive = async ({comp_cd, branch_cd, flag,gd_date,user_level,user_name}) => {
  ...
  export const getVoucherDetail = async ({ENT_COMP_CD,ENT_BRANCH_CD,GD_DATE,TRAN_CD }) => {
    const { status, data, message, messageDetails } =
