...
export const CardBinImageConfirm = () => {
  ...
  const { data, isLoading, isFetching, isError, error, refetch } = useQuery<
    any,
    any
  >(["getCardBinImageGridData", "N"], () => API.getCardBinImageGridData("N"));
  const result = useMutation(API.confirmCardBinImageReq, {
  ...
  useEffect(() => {
    return () => {
      queryClient.removeQueries(["getPGWGridData", "N"]);
    };
  }, [getEntries]);
  CardGridMetaData.gridConfig.gridLabel = "PGW Configuration Confirmation";
