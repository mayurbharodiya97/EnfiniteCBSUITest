...
export const ParameterConfirmGridWrapper = () => {
  ...
  const { data, isLoading, isFetching, isError, error, refetch } = useQuery<
    any,
    any
  >(["getParameterConfirmGridData"], () => API.getParameterConfirmGridData());
  ...
  const result = useMutation(API.confirmParemeterReq, {
  ...
  useEffect(() => {
    return () => {
      ...
      // });
      queryClient.removeQueries(["getParameterConfirmGridData"]);
    };
  }, [getEntries]);
