...
export const PGWConfigConfirm = () => {
  ...
  const { data, isLoading, isFetching, isError, error, refetch } = useQuery<
    any,
    any
  >(["getPGWGridData", "N"], () => API.getPGWGridData("N"));
  const result = useMutation(API.confirmPgwMerUserReq, {
  ...
  PGWGridMetaData.gridConfig.gridLabel = "PGW Configuration Confirmation";
