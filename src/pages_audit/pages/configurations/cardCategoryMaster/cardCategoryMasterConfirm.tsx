...
import { ViewEditCardCategoryMasterWrapper } from "./cardCategoryMasterCrud";
import * as API from "./api";
import { useSnackbar } from "notistack";
import { CardCategoryMasterConfirmationGridMetaData } from "./gridMetaData";
...
export const CardCategoryMasterConfirm = () => {
  ...
  return (
    <Fragment>
      ...
      <GridWrapper
        ...
        //@ts-ignore
        finalMetaData={CardCategoryMasterConfirmationGridMetaData}
        data={data ?? []}
        setData={() => null}
        actions={actions}
