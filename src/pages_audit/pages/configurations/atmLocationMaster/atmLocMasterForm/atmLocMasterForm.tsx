...
import { AtmLocMasterFormMetadata } from "./metaData";
...
const AtmLocMasterForm: FC<{
  ...
  const mutation = useMutation(
    updateAUTHDetailDataWrapperFn(API.updAtmLocMasterFormData),
  ...
  const masterMetadata: MetaDataType = useMemo(
    () => extractMetaData(AtmLocMasterFormMetadata, formView),
    [AtmLocMasterFormMetadata, formView, ""]
  ) as MetaDataType;
  return (
    <>
      <FormWrapper
        key={"AtmLocMasterForm"}
...
export const AtmLocMasterFormWrapper = ({
  handleDialogClose,
  isDataChangedRef,
  formView,
}) => {
