...
import { chargeTempMasterConfirmationGridMetaData } from "./metadata/grid";
...
export const ChargeTemplateMasterConfirm = () => {
  ...
  return (
    <Fragment>
      ...
      <GridWrapper
        ...
        //@ts-ignore
        finalMetaData={chargeTempMasterConfirmationGridMetaData}
        data={data ?? []}
        setData={() => null}
        actions={actions}
